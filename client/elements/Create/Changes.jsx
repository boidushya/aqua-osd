...
const Changes = () => {
	...
	useEffect(() => {
		const equalityCheck = (deepEqual({
			...
			courseCode:initialState.files.courseCode,
			courseName:initialState.files.courseName,
			credits:initialState.files.credits,
			timeSpan:initialState.files.timeSpan,
			date:initialState.files.date,
		},{
			file:files.file,
			courseCode:files.courseCode,
			courseName:files.courseName,
			credits:files.credits,
			timeSpan:files.timeSpan,
			date:files.date,
		}))
		if(!equalityCheck){
			setAnimateOut(false)
